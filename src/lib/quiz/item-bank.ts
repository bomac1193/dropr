...
export type QuestionType = 'ab' | 'multiple' | 'image' | 'slider' | 'audio';
...
export const itemBank: ItemBankQuestion[] = [
  ...
  // =============================================================================
  // AUDIO QUESTIONS (6 questions)
  // =============================================================================
  {
    id: 'audio_1_atmosphere',
    type: 'audio',
    text: 'Which soundscape draws you in?',
    subtext: 'Tap to preview each audio clip',
    primaryTrait: 'aestheticSensitivity',
    secondaryTraits: { openness: 0.4, extraversion: 0.3 },
    difficulty: 0.3,
    discrimination: 1.6,
    isAnchor: false,
    category: 'aesthetic',
    answers: [
      {
        id: 'audio_1_a',
        text: 'Ambient drone',
        audioUrl: '/audio/quiz/ambient-drone.mp3',
        audioDurationMs: 15000,
        traitDeltas: { aestheticSensitivity: 0.15, openness: 0.1 },
        aestheticAdjustment: { tempoCenter: -20, energyCenter: -0.2 },
        value: 0.25,
      },
      {
        id: 'audio_1_b',
        text: 'Rhythmic electronic',
        audioUrl: '/audio/quiz/rhythmic-electronic.mp3',
        audioDurationMs: 15000,
        traitDeltas: { noveltySeeking: 0.1, extraversion: 0.1 },
        aestheticAdjustment: { tempoCenter: 20, energyCenter: 0.2, acousticVsDigital: 0.3 },
        value: 0.5,
      },
      {
        id: 'audio_1_c',
        text: 'Acoustic folk',
        audioUrl: '/audio/quiz/acoustic-folk.mp3',
        audioDurationMs: 15000,
        traitDeltas: { agreeableness: 0.1, aestheticSensitivity: 0.1 },
        aestheticAdjustment: { acousticVsDigital: -0.4, organicVsSynthetic: -0.3 },
        value: 0.75,
      },
      {
        id: 'audio_1_d',
        text: 'Intense industrial',
        audioUrl: '/audio/quiz/intense-industrial.mp3',
        audioDurationMs: 15000,
        traitDeltas: { riskTolerance: 0.15, noveltySeeking: 0.1 },
        aestheticAdjustment: { energyCenter: 0.4, darknessPreference: 0.3 },
        value: 1,
      },
    ],
  },
  {
    id: 'audio_2_energy',
    type: 'audio',
    text: 'Which energy matches your ideal creative state?',
    primaryTrait: 'extraversion',
    secondaryTraits: { aestheticSensitivity: 0.5, noveltySeeking: 0.3 },
    difficulty: 0.4,
    discrimination: 1.5,
    isAnchor: false,
    category: 'aesthetic',
    answers: [
      {
        id: 'audio_2_a',
        text: 'Calm and meditative',
        audioUrl: '/audio/quiz/calm-meditative.mp3',
        audioDurationMs: 15000,
        traitDeltas: { extraversion: -0.15, aestheticSensitivity: 0.1 },
        aestheticAdjustment: { tempoCenter: -30, energyCenter: -0.3 },
        value: 0,
      },
      {
        id: 'audio_2_b',
        text: 'Flowing and dynamic',
        audioUrl: '/audio/quiz/flowing-dynamic.mp3',
        audioDurationMs: 15000,
        traitDeltas: { openness: 0.1, noveltySeeking: 0.1 },
        aestheticAdjustment: { tempoCenter: 0, energyCenter: 0 },
        value: 0.5,
      },
      {
        id: 'audio_2_c',
        text: 'Driving and intense',
        audioUrl: '/audio/quiz/driving-intense.mp3',
        audioDurationMs: 15000,
        traitDeltas: { extraversion: 0.15, riskTolerance: 0.1 },
        aestheticAdjustment: { tempoCenter: 25, energyCenter: 0.3 },
        value: 1,
      },
    ],
  },
  {
    id: 'audio_3_texture',
    type: 'audio',
    text: 'Which sonic texture resonates with you?',
    primaryTrait: 'openness',
    secondaryTraits: { aestheticSensitivity: 0.6 },
    difficulty: 0.5,
    discrimination: 1.7,
    isAnchor: false,
    category: 'aesthetic',
    answers: [
      {
        ...
        audioUrl: '/audio/quiz/clean-minimal.mp3',
        audioDurationMs: 15000,
        traitDeltas: { conscientiousness: 0.1 },
        aestheticAdjustment: { complexityPreference: -0.3, minimalVsMaximal: -0.3 },
        value: 0,
      },
      {
        id: 'audio_3_b',
        text: 'Layered and complex',
        audioUrl: '/audio/quiz/layered-complex.mp3',
        audioDurationMs: 15000,
        traitDeltas: { openness: 0.15, aestheticSensitivity: 0.1 },
        aestheticAdjustment: { complexityPreference: 0.3, minimalVsMaximal: 0.2 },
        value: 0.7,
      },
      {
        id: 'audio_3_c',
        text: 'Distorted and experimental',
        audioUrl: '/audio/quiz/distorted-experimental.mp3',
        audioDurationMs: 15000,
        traitDeltas: { openness: 0.2, noveltySeeking: 0.15, riskTolerance: 0.1 },
        aestheticAdjustment: { complexityPreference: 0.4, darknessPreference: 0.2 },
        value: 1,
      },
    ],
  },
  {
    id: 'audio_4_mood',
    type: 'audio',
    text: 'Which mood feels most like home?',
    primaryTrait: 'neuroticism',
    secondaryTraits: { aestheticSensitivity: 0.5, extraversion: 0.4 },
    difficulty: 0.3,
    discrimination: 1.4,
    isAnchor: false,
    category: 'aesthetic',
    answers: [
      {
        id: 'audio_4_a',
        text: 'Bright and uplifting',
        audioUrl: '/audio/quiz/bright-uplifting.mp3',
        audioDurationMs: 15000,
        traitDeltas: { neuroticism: -0.15, extraversion: 0.1 },
        aestheticAdjustment: { darknessPreference: -0.4, energyCenter: 0.2 },
        value: 0,
      },
      {
        id: 'audio_4_b',
        text: 'Melancholic and deep',
        audioUrl: '/audio/quiz/melancholic-deep.mp3',
        audioDurationMs: 15000,
        traitDeltas: { neuroticism: 0.1, aestheticSensitivity: 0.15 },
        aestheticAdjustment: { darknessPreference: 0.3, tempoCenter: -15 },
        value: 0.7,
      },
      {
        id: 'audio_4_c',
        text: 'Dark and brooding',
        audioUrl: '/audio/quiz/dark-brooding.mp3',
        audioDurationMs: 15000,
        traitDeltas: { neuroticism: 0.15, openness: 0.1 },
        aestheticAdjustment: { darknessPreference: 0.5, energyCenter: -0.1 },
        value: 1,
      },
    ],
  },
  {
    id: 'audio_5_rhythm',
    type: 'audio',
    text: 'Which rhythm pattern moves you?',
    primaryTrait: 'noveltySeeking',
    secondaryTraits: { extraversion: 0.4, riskTolerance: 0.3 },
    difficulty: 0.4,
    discrimination: 1.5,
    isAnchor: false,
    category: 'aesthetic',
    answers: [
      {
        ...
        audioUrl: '/audio/quiz/steady-predictable.mp3',
        audioDurationMs: 15000,
        traitDeltas: { conscientiousness: 0.1, noveltySeeking: -0.1 },
        aestheticAdjustment: { tempoCenter: 0 },
        value: 0,
      },
      {
        id: 'audio_5_b',
        text: 'Syncopated and groovy',
        audioUrl: '/audio/quiz/syncopated-groovy.mp3',
        audioDurationMs: 15000,
        traitDeltas: { noveltySeeking: 0.1, extraversion: 0.1 },
        aestheticAdjustment: { tempoCenter: 10 },
        value: 0.5,
      },
      {
        id: 'audio_5_c',
        text: 'Chaotic and unpredictable',
        audioUrl: '/audio/quiz/chaotic-unpredictable.mp3',
        audioDurationMs: 15000,
        traitDeltas: { noveltySeeking: 0.2, riskTolerance: 0.15, openness: 0.1 },
        aestheticAdjustment: { complexityPreference: 0.3 },
        value: 1,
      },
    ],
  },
  {
    id: 'audio_6_genre',
    type: 'audio',
    text: 'Which genre world would you explore?',
    primaryTrait: 'openness',
    secondaryTraits: { aestheticSensitivity: 0.5, noveltySeeking: 0.4 },
    difficulty: 0.5,
    discrimination: 1.6,
    isAnchor: false,
    category: 'aesthetic',
    answers: [
      {
        ...
        audioUrl: '/audio/quiz/classical-orchestral.mp3',
        audioDurationMs: 15000,
        traitDeltas: { aestheticSensitivity: 0.15, conscientiousness: 0.1 },
        aestheticAdjustment: { acousticVsDigital: -0.5, complexityPreference: 0.2 },
        value: 0.25,
      },
      {
        id: 'audio_6_b',
        text: 'Lo-fi hip hop',
        audioUrl: '/audio/quiz/lofi-hiphop.mp3',
        audioDurationMs: 15000,
        traitDeltas: { openness: 0.1, agreeableness: 0.1 },
        aestheticAdjustment: { tempoCenter: -10, energyCenter: -0.1 },
        value: 0.5,
      ...
      {
        id: 'audio_6_c',
        text: 'Hyperpop glitch',
        audioUrl: '/audio/quiz/hyperpop-glitch.mp3',
        audioDurationMs: 15000,
        traitDeltas: { noveltySeeking: 0.2, openness: 0.15, riskTolerance: 0.1 },
        aestheticAdjustment: { acousticVsDigital: 0.5, energyCenter: 0.3, complexityPreference: 0.3 },
        value: 1,
      },
      {
        id: 'audio_6_d',
        text: 'World fusion',
        audioUrl: '/audio/quiz/world-fusion.mp3',
        audioDurationMs: 15000,
        traitDeltas: { openness: 0.15, agreeableness: 0.1 },
        aestheticAdjustment: { organicVsSynthetic: -0.2 },
        value: 0.75,
      },
    ],
  },
